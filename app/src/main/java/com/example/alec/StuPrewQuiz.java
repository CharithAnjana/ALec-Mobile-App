...
public class StuPrewQuiz extends AppCompatActivity {

    String qID,qName,qtCount;
    TextView Quiz;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stu_prew_quiz);
        ...
        qQuestionListView = (ListView)findViewById(R.id.quizQuestionListStu);
